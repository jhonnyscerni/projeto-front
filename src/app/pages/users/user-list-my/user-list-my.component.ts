...
@Component({
  selector: 'app-user-list-my',
  templateUrl: './user-list-my.component.html',
  styleUrls: ['./user-list-my.component.scss']
})
export class UserListMyComponent implements OnInit {
  users: User[];
  errorMessage: string;
