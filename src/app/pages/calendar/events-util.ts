...
var dataBase01 = new Date(year, month, 1, 0, 0).toISOString()
var dataBase02 =  new Date(year, month, 1, 23, 59).toISOString()

export const TESTE: Appointment[] = [
  {
    className: "fc-event-warning",
    comments: "string",
    dateAppointment: new Date(year, month, 1, 0, 0),
    groupId: "work",
    id: "3fdaf05b-6da9-4778-a424-8c1713e87acd",
    locationService: "string",
    start: new Date(year, month, 1, 0, 0).toISOString(),
    title: "Compromisso de Fulano de Tal",
  }
]
