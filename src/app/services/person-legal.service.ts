...
export class PersonLegalService extends CrudService<User> {
  ...
  constructor(protected http: HttpClient) {
    super(http, `${environment.urlbase}/politicalmanagement/persons-legal`);
  }

  listMy(): Observable<PersonPhysical[]> {
    return this.http.get<PersonPhysical[]>(`${environment.urlbase}/politicalmanagement/persons-legal/my`)
        .pipe(
